...
export const MOSQUITO_PAGES: EbookPage[] = [
  {
    page: 1,
    imageUrl:
      'https://pub-554d78bf0f2346cfb850060ac23280a7.r2.dev/ebook/mosquito/img/v1/page-01.webp',
    narration: {
      ko: '',
      ja: '',
    },
  ...
  },
  {
    page: 4,
    imageUrl:
      'https://pub-554d78bf0f2346cfb850060ac23280a7.r2.dev/ebook/mosquito/img/v1/page-04.webp',
    narration: {
  ...
  },
  {
    ...
    overlays: [
      ...
      },
      {
        ...
        kind: '라벨',
        text: {
          ko: '소:곡물 7kg 46인분 / 돼지:4kg 26인분 / 닭:2kg 13인분',
