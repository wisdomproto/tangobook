...
export const EBOOK_LANGS: readonly EbookLang[] = ['ko', 'ja'] as const;
export const EBOOK_LANG_LABEL: Record<EbookLang, string> = { ko: '한국어', ja: '日本語' };
...
export const MOSQUITO_PAGES: EbookPage[] = [
  {
    page: 1,
    // 모기를 하단 배치 + 상단 크림 여백(제목용)으로 재합성한 표지. 프레임선 제거. 로컬 public(client·remotion).
    imageUrl: 'ebook/mosquito/cover-v3.webp',
    narration: {
      ko: '',
      ja: '',
    },
  ...
  {
    page: 4,
    // 원본(글자판)에 있던 모기를 추출해 손 옆에 합성한 버전(원본 깨끗본엔 모기 누락). 로컬 public.
    imageUrl: 'ebook/mosquito/page-04-v2.webp',
    narration: {
    ...
    overlays: [
      {
        ...
        lineIndex: 0,
        kind: '라벨',
        text: { ko: '소 1kg = 곡물 7kg', ja: '牛1kg = 穀物7kg' },
        x: 0.29,
        y: 0.41,
        anim: 'pop',
        delaySec: 0.3,
      ...
      },
      {
        ...
        lineIndex: 5,
        kind: '라벨',
        text: { ko: '돼지 1kg = 곡물 4kg', ja: '豚1kg = 穀物4kg' },
        x: 0.29,
        y: 0.68,
        anim: 'pop',
        delaySec: 0.3,
      ...
      },
      {
        ...
        lineIndex: 6,
        kind: '라벨',
        text: { ko: '닭 1kg = 곡물 2kg', ja: '鶏1kg = 穀物2kg' },
        x: 0.7,
        y: 0.9,
        anim: 'pop',
        delaySec: 0.3,
...
/** 실제 노출 페이지 — 샘플 한정(SAMPLE_PAGE_LIMIT). 컴포지션·웹 Player·렌더가 공통으로 사용. */
