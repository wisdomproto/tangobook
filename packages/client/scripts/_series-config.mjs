...
/** 🔴 코타 손님 등록부 — 종마다 하나. 외형·옷·자연 무늬는 첨부한 해당 손님 시트를 따른다.
...
export const KOTA_GUESTS = {
  "Guest crane": {
    ...
    "desc": "키가 아주 큰 두루미. 첨부한 두루미 손님 시트의 몸색·목깃·부리·옷색과 밑단을 그대로 유지한다."
  },
  "Guest boar": {
    "key": "boar",
    "name": "멧돼지 손님",
    ...
    "desc": "코가 길고 어깨가 두툼한 멧돼지. 첨부 시트의 털색·주둥이·겹옷과 보퉁이를 유지한다."
  },
  "Guest turtle": {
    "key": "turtle",
    "name": "거북 손님",
    ...
    "desc": "등이 굽은 늙은 거북. 첨부 시트의 얼굴·등딱지·옷색·지팡이를 유지한다."
  },
  "Guest owl": {
    "key": "owl",
    "name": "부엉이 손님",
    ...
    "desc": "눈이 큰 부엉이. 첨부 시트의 깃·얼굴판·옷색을 유지한다. 밤에 다니고 아침에 자는 밤손님이다."
  },
  "Guest hippo": {
    "key": "hippo",
    "name": "하마 손님",
    ...
    "desc": "몸집이 크고 둥근 하마. 첨부한 하마 시트의 피부색·주둥이·눈 주변·옷색을 유지한다. 참조에 없는 검은 눈 반점이나 띠를 추가하지 않는다. 아이 손님인 장면에서는 아이 비례를 유지한다."
  },
  "Guest swan": {
    "key": "swan",
    "name": "백조 손님",
    ...
    "desc": "목이 길고 걸음이 사뿐한 백조. 첨부 시트의 깃·부리·옷색을 유지한다."
  },
  "Guest frog": {
    "key": "frog",
    "name": "개구리 손님",
    ...
    "desc": "불룩한 두 눈의 개구리 아이. 첨부 시트의 피부색·눈·옷색과 짧은 밑단을 유지한다."
  },
  "Guest ox": {
    "key": "ox",
    "name": "황소 손님",
    ...
    "desc": "어깨가 넓고 두 뿔이 있는 황소. 첨부 시트의 얼굴·뿔·옷색과 짐을 유지한다."
  },
  "Guest heron": {
    "key": "heron",
    "name": "왜가리 손님",
    ...
    "desc": "다리가 가늘고 긴 왜가리. 첨부 시트의 깃·부리·댕기 깃·옷색을 유지한다. 깃무늬를 표정 때문에 바꾸지 않는다."
  },
  "Guest tanuki": {
    "key": "gtanuki",
    "name": "너구리 손님",
    ...
    "desc": "너구리 손님. 코타나 아빠가 아니라 첨부한 손님 시트의 얼굴 무늬·옷·소지품을 유지한다. 코타의 분홍 수건을 임의로 두르지 않는다."
  }
};
