// 자연 관찰 광고 릴스 — 「단어 익히기」 게임 실촬(명작 스크립트 포크, 책만 다르다).
//   node scripts/capture-nature-games.mjs <baseUrl> <outDir> [clip...]
//
...
const BOOK = '1773714531390'; // 티라노사우루스 렉스 — 낱말 10개(숲·야자수·이빨·…·발톱)
...
try {
  ...
  if (want('g5-reveal')) {
    ...
    const SCENE_WORDS = ['이빨', '꼬리', '알', '화석', '발', '발톱'];
    let target = null;
