...
export const BOOKS_BY_CATEGORY: { cat: string; id: string; title: string }[] = [
  { cat: '세계 명작', id: '1778555233699', title: '백설공주' },
  { cat: '전래 동화', id: '1785303658036', title: '반쪽이' },
  { cat: '호리네 생활동화', id: '1783990336946', title: '고마워, 자연아!' },
  { cat: '호리 유치원동화', id: '1784550873799', title: '내일 또 만나요' },
  { cat: '호리 세상 탐험', id: '1784860653877', title: '편지 배달 왔어요' },
  { cat: '육지 동물 친구들', id: '1777615082301', title: '캥거루' },
  { cat: '바다 동물 친구들', id: '1777614294799', title: '바다거북' },
  { cat: '곤충 친구들', id: '1777607890313', title: '장수풍뎅이' },
  { cat: '하늘 동물 친구들', id: '1777602265786', title: '오리' },
];
  ...
  return (
    <div className="my-7 overflow-hidden rounded-[26px] border border-mint-200 bg-white shadow-sm">
          ...
          {(
            ...
            <button
              ...
              className={`min-h-[36px] rounded-full px-4 text-xs font-bold transition ${
                mode === m ? 'bg-mint-500 text-white' : 'text-ink-500 hover:bg-mint-50'
              }`}
            >
              {label}
            </button>
      ...
      <div
        ...
        /* 🔴 뷰어·게임이 `100dvh` 를 쓰므로 상자도 그 안에 맞춘다 — 파닉스 상자와 같은 이유. */
        style={{
          height: `min(${mode === 'read' ? 620 : 700}px, 88dvh)`,
