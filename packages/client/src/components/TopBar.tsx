...
const CHANGJAK: ResourceItem[] = [
  ...
  },
  {
    ...
    icon: '🦝',
    label: '16 · 코타와 오늘의 손님',
    desc: '아기 너구리 코타 + 아빠 · 일본 온천 여관 · 매권 낯선 손님 하나 · 페파형 · 니혼가 암채 · 글 오하람 / 그림 유하람',
  },
  // 🔴 17 부터 = 호리 45편 주제 은행(_TOPICS.md) — 권마다 호리 그 편을 옆에 놓고 쓴다
  {
    href: '/moya-plan.html',
    icon: '🦓',
    label: '17 · 모야네 물웅덩이',
    desc: '얼룩말 모야·미어캣·혹멧돼지·기린 앙상블 · 아프리카 초원 물웅덩이 · 호리형 · 투명 수채 나란히 · 주제 = 호리 은행',
  },
  {
    href: '/bami-plan.html',
    icon: '🦉',
    label: '18 · 밤이네 기차',
    desc: '올빼미 아이 밤이 + 기관사 아빠 · 산골 기찻길을 도는 작은 기차가 집 · 손님은 역마다 · 과슈, 어두운 종이에 등불만 · 주제 = 호리 은행',
  },
  {
    href: '/dari-plan.html',
    icon: '🦭',
    label: '19 · 달이네 등대',
    desc: '물범 아이 달이 + 등대지기 가족 · 섬 끝 등대, 손님은 배로 · 흰 왁스 크레용 + 파란 워시 · 주제 = 호리 은행(첫 시리즈)',
  },
];
...
const RESOURCES: ResourceItem[] = [
  ...
  {
    href: '/samgukji-master.html',
    icon: '🗺️',
    label: '탱고북 삼국지 마스터',
    desc: '삼국지 라인 입구 · 한눈에 수치·권별 표·캐릭터 시트 발주 현황·빌더 검사·남은 일. 숫자는 여기가 원본이다',
  },
  {
    href: '/samgukji-plan.html',
    icon: '📕',
    label: '탱고북 삼국지 기획서',
    desc: '시리즈물 · 초등 저학년 · 도원결의~오장원 · 그림체 앵커 + 캐릭터 시트 프롬프트와 붙여넣기. 그림 발주는 여기서 한다(☰ 회차)',
  },
  {
    href: '/samgukji-tree.html',
    icon: '🌳',
    label: '탱고북 삼국지 — 트리',
    desc: '권 › 장 › 쪽 › 컷. 나레이션과 대사(말풍선)를 갈라 놓은 원고 전문, 층마다 접고 펌',
  },
  {
    href: '/samgukji-read.html',
    icon: '📖',
    label: '탱고북 삼국지 — 글만 읽기',
    desc: '24권 본문을 처음부터 끝까지 한 페이지에. 삽화 지시·발주 도구 없이 이야기만',
  },
  {
