...
(function () {
  ...
  // ── 🔴 STYLE SSOT — 그림체 확정(art-style-bakeoff: B 펠트 vs F 아기상어 대결 중) 시 이 블록만 교체 ──
  var STYLE_PROMPT = [
    '[스타일] 호리네 생활동화 — 3~5세 유아 그림책 일러스트.',
    '따뜻하고 포근한 색감, 부드러운 브라운 계열 외곽선, 은은한 에어브러시 셰이딩.',
    '슈퍼-디폼드 치비 비율(머리≈몸통 1.3배, 짧고 통통한 팔다리, 크고 둥근 눈+흰 하이라이트, 분홍 볼터치).',
    '밝고 친근한 팔레트, 부드러운 심도(depth-of-field) 배경. 화면비 16:9 스프레드.',
  ...
  var FIXED_CHARS = [
    ...
    { key: 'mom',   name: '엄마',  aliases: ['Mom tiger', 'Mom', 'mother tiger', '엄마'],
      desc: '엄마 호랑이 — 호리와 같은 팔레트, 키 크고 날씬, 자상한 반쯤 감은 눈, 복숭아색 앞치마.' },
    { key: 'dad',   name: '아빠',  aliases: ['Dad', 'father tiger', 'Daddy', '아빠'],
      desc: '아빠 호랑이 — 진한 주황 털, 굵은 갈색 줄무늬, 든든한 체구, 작고 둥근 안경, 큰 미소.' },
