/*
 * tamheom-core.js — 호리네 세상 탐험 회차 공용 스크립트 (saenghwal-core.js 포크: index/plan 경로만 상이, 캐스트·스타일 동일)
...
(function () {
  ...
  (async function () {
    ...
    var idx = [];
    try { var ri = await fetch('/tamheom-index.json'); idx = await ri.json(); } catch (e) {}
    var eps = idx
      .filter(function (e) { return e.file && e.file !== 'tamheom-plan.html'; })
      .map(function (e) {
