 ...
 * 🔴 앵커는 `docs/art-direction/mei-anchor.md` 에서 **빌드 때 통째로 주입**된다 —
...
(function () {
  ...
  var FIXED_CHARS = [
  {
    ...
    "spec": "- 아기 염소 — 흰 몸, 짧은 뿔 두 개, 늘어진 귀. 다섯 중 제일 작다. 겁이 많아 어깨가 자주 움츠러들어 있다. 🔴 주황 목도리 하나."
  },
  {
    "key": "rudi",
    "name": "루디",
    ...
    "spec": "- 다람쥐 — 등 뒤로 말려 올라간 큼직한 꼬리 하나가 실루엣을 만든다. 앞치마를 둘렀고 🔴 앞치마 주머니가 주황."
  },
  {
    "key": "ppino",
    "name": "삐노",
    ...
    "spec": "- 토끼 — 곧게 선 긴 귀 두 개. 아이들 중 제일 키가 크다. 늘 앞으로 기울어진 자세. 🔴 주황 장화."
  },
  {
    "key": "soso",
    "name": "소소",
    ...
    "spec": "- 고슴도치 — 짧은 가시가 덮인 낮고 둥근 등. 손을 앞으로 모으고 있다. 🔴 머리에 주황 리본."
  },
  {
    "key": "leo",
    "name": "레오",
    ...
    "spec": "- 여우 — 뾰족한 주둥이와 길게 뻗은 꼬리 하나. 턱을 든 자세. 🔴 주황 목깃."
  },
  {
    "key": "granny",
    "name": "곰 할머니",
    ...
    "spec": "- 큰 곰 — 아이 키의 두 배, 전체가 둥글다. 산장 주인이자 이 마을의 유일한 어른. 🔴 주황색을 하나도 지니지 않는다. 아이들이 하던 그 일을 같이 하고 있는 모습으로만 등장한다."
  }
];
