 ...
 * 🔴 앵커는 `docs/art-direction/moya-anchor.md` 에서 **빌드 때 통째로 주입**된다 —
...
(function () {
  ...
  var FACE = {"moya":"🦓","kiki":"🦫","tumba":"🐗","nia":"🦒","mother":"🦓"};
 ...
 * 🔴 SSOT 는 docs/changjak-books/moya/*.md 이고 이것은 그 위에 얹는 오버레이다.
