...
**② 이 시리즈에서 실제로 가라앉는 사물은 하나뿐이다.** 500쪽을 「윤곽/잠긴」으로 전수해 보면 물 위의
사물은 **전부 윤곽을 그대로 두른 채 뜬다**(02 모자 · 08 수박 · 11 신 · 38 열매 · 44 그물). 윤곽을 잃는 것은
**고정된 것의 잠긴 부분**(14 나무뿌리 · 23 나무 길 · 38 기둥 아랫동 · 22 젖은 발)과 🔴 **23권의 봉지 하나**뿐이다.
→ §3.19 `Packet` 상태 4가 §0 규칙의 유일한 사물 실례이고, **나머지 시트에 「가라앉은 상태」를 넣지 않았다**
