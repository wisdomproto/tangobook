...
> art-director 산출물 (2026-08-16). 시리즈 15 `mina-dotfolk` · 25권 250쪽.
...
## §2. 사물 시트 — 44장 (고유 59에서 노이즈 15 제외)

| 토큰 | 사물 | 권·쪽 | 비고 |
|---|---|---|---|
| `ThreeBowls` | 그릇 셋 | 20(9) · 19(6) · 12(5) · 04(3) | 🔴 **삼 남매 하나씩 — 크기 계단이 곧 나이 계단** |
| `Jars` | 항아리 | 16(8) · 01(6) | 흙갈 / 뚜껑 |
| `Beads` | 구슬 | 12 (8쪽) | |
| `Baskets` | 바구니 셋 | 11 (5쪽) | 🔴 셋이 같은 크기 — 그릇과 반대 |
| `Gourd` | 바가지 | 16(6) · 10(4) | |
| `Shells` | 조개 · 흰 껍데기 | 11 · 20(4) | 🔴 흰 점이라 바닥에서 도드라진다 |
| `Bundle` | 나뭇단 | 15 (5쪽) | 묶인 / 풀린 |
| `Cloth` | 수건 · 빨래 | 06(7) · 12(4) | |
| … | (나머지 36장) | | |
