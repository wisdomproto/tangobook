...
the camera moves only between the stall top and the earth box under it. Opaque
gouache on warm laid paper; the bare paper itself is the ground and is left
unpainted wherever a page says empty. TWO WAYS OF MAKING A MARK, and they never
mix. (1) STAMPED: the back band of market people is ONE hand-cut stamp of a
hooded standing figure, inked flat grey and repeated with only the spacing
changed - identical impression, no faces, no hands, no separated legs, 0
information. (2) PAINTED: everything else, brush marks visible, each object with
its own edge. Never stamp a tulip, bucket, animal or the soil.
...
darkest and most worked place). The finish never returns to a thing it has left -
from p10 all remaining red drops to flat 0-2 strokes. Everything else = at most 2
strokes per object. Stall boards = 0 grain except one plank line.
DENSITY RATION = p1 only (buckets packed full, band at 6 figures); every other
page keeps the surround open.

PALETTE
#C62828 tulip red - the only red in the book; it shrinks off the spread as the
flowers sell / #9AA3A6 zinc bucket grey / #7E6A50 wet stall timber / #3A2A1E
...
NO CLOTHES, natural four-legged proportion; the badger rises on his hind legs at
the stall and uses his forepaws as hands - the only liberty. Eyes = small round
black dots, no whites, no eyebrows. The goose stays a bird: neck, wings, beak, no
...
border, no reserved margin, bottom included. NO letters, numbers, price tags,
signage or symbols of any kind, in any language.

NOT (rendering only)
- no faces, hands or variation inside the stamped band; one impression repeated
...
and band stay raw, at most 2 strokes per object.
WATER: 0 visible - all five buckets packed so tight no water shows.
CROWD: 6 stamped figures across the back band, one impression repeated, spacing
uneven, no faces, no hands. The ONE page allowed full density.
CAMERA: medium, child eye level, frontal, lens at stall-top height.
...
open speaking. GRADE: no clothes, natural proportion, forepaws as hands. At
right the Old Goose stands behind the bucket row, neck upright, watching.
SETTING: one stall bay, five zinc buckets in a row on a wet timber top. Under
the stall a shallow wooden earth box: on the black soil the top of one brown
bulb shows at the lower corner - neither animal looks at it.
TONE: low early light. The single densest colour on the spread is the red tulip
mass. NO letters, numbers or price tags.
```
...
watching it go. No clothes on either, natural animal proportion, forepaws used
as hands, the goose keeps wings not hands.
...
just enough for ONE round patch of water, exactly the width of one forepaw. It
is a flat zinc-grey disc, no reflection, no ripple pattern, no sky in it.
...
against the rim. GRADE: no clothes, natural proportion, forepaws as hands.
SETTING: the bucket mouth, vertical ribs on its outer wall, one torn leaf
floating on the water. Outside the bucket the page is left as bare warm paper.
TONE: one ring of morning light on the water. Only the paw and the water disc
are finished besides the flowers. NO letters, numbers or price tags.
```
...
WATER: not measured this page - only 3-4 drops falling from the lifted stem
ends, painted as separate marks.
...
the remaining buckets are held back. NO letters, numbers or price tags.
```
...
SETTING: a half-rolled paper sheet with red heads showing out of one end; two
wet leaves lying flat and stuck to the boards; one cut stem end. Nothing else.
...
```
--- p6 — 여기까지 물이에요 (2) ---
FINISH: the few red tulip heads left standing against the bucket wall - 6-9
ridge strokes each - plus the badger's two forepaws on the water.
...
elbows out, shoulders pushed forward so his chest hangs over the bucket, head
up, mouth open shouting, eyes wide. No clothes, natural badger proportion,
forepaws used as hands.
SETTING: behind him on the stall top, two empty buckets lying on their sides
with their mouths toward the viewer, and under each a round wet mark on the
boards. Bare paper elsewhere.
TONE: straight overhead midday light; the water patch is the brightest area of
the spread. NO letters, numbers or price tags.
```
...
strokes each. The hanging bucket, goose and badger stay raw, at most 2 strokes.
...
space UNDERNEATH are both in the picture.
SUBJECT: Old Goose centre, neck hooked through the handle of an empty bucket and
lowering it, so the bucket hangs in the air between the boards and the ground,
her neck stretched long and down. At left the Badger Cub on his hind legs holds
the far side of the same handle with both forepaws and pulls it back, heels
lifted, mouth wide open. GRADE: no clothes, natural proportion, forepaws as
hands, wings not hands.
SETTING: under the stall, in shade, the wooden earth box - the top of the brown
bulb still just above the black soil, unchanged since p1 and still unlooked-at.
Soil stays raw, 0-2 strokes.
TONE: the afternoon has tipped; light lies on the stall top only, the space
below in shade, one bright line along the hanging bucket rim. NO letters,
...
bucket edge, mouth only slightly open, eyelids half lowered (posture 2). GRADE:
no clothes, natural proportion, forepaws as hands.
...
TONE: low late light entering from the side reaches the inner wall of the
bucket. Water takes most of the spread. NO letters, numbers or price tags.
```
...
picture. Stall top, badger and goose stay raw.
WATER: none - the stall top is bare, five round wet marks all that is left.
CROWD: 3 stamped figures, one impression, spaced wider than p1 so the band
thins.
CAMERA: wide medium, child eye level, frontal - THE SAME VIEWPOINT AS p1. Match
p1 stall coordinates so the empty top reads against the full one.
SUBJECT: Badger Cub centre, both forepaws laid flat and spread on the empty
boards, caught halfway to resting his chin on them, shoulders sunk, tail
hanging, eyes following the board. At right the Old Goose stretches her neck out
and pushes the last wrapped bundle past the frame edge, so only the paper end is
still in the picture (posture 1). GRADE: no clothes, natural proportion,
forepaws as hands, wings not hands.
...
the frame. NO letters, numbers or price tags.
```
...
skin worked with 12-16 strokes, its own edge, the only finished object in frame.
Red drops out of the picture entirely; badger, goose and boards stay raw at 0-2
strokes.
WATER: out of frame.
CROWD: 2 stamped figures, one impression, far apart.
CAMERA: medium close-up at stall-top height, child eye level.
SUBJECT: Old Goose at right has just set the bulb down - it is touching the wood
and her beak is still above it, neck bent low. At left the Badger Cub rests his
chin flat on the boards with only his eyes lifted, looking at the bulb from a
nose's length away, both forepaws folded in front of him. No clothes on either,
natural animal proportion, forepaws used as hands, wings not hands.
...
```
--- p11 — 이건 물에 안 세울래요 ---
FINISH: the brown bulb in his forepaws - 12-16 strokes, still the only finished
thing. The bucket behind him is deliberately raw, 0-2 strokes.
WATER: one bucket of water stands on the boards BEHIND HIM - the thing he turns
his back on. Flat zinc-grey, no reflection, no highlight.
CROWD: 0 - the band is out of frame.
CAMERA: medium, child eye level from the side, framed so the stall TOP is upper
and the earth box below it lower, both in one picture.
SUBJECT: Badger Cub centre, holding the bulb against his chest with both
forepaws, body turned down so his back is to the stall top - the bucket visible
over his shoulder - while nose and eyes point straight down at the earth box.
One hind foot has already stepped toward the space beneath. Mouth half closed,
speaking. No clothes, natural badger proportion, forepaws used as hands. Above,
the Old Goose enters as neck only, her eye following him.
SETTING: the black soil and the shallow hollow below; the underside grain of the
boards; nothing else. Green on this spread: at most one thumb's worth, and none
near the soil.
TONE: long low light before evening - the water above cold and flat, the soil
below warm. NO letters, numbers or price tags.
```
...
work on the spread. The visible top of the bulb is second; nothing else on the
page is finished at all, and the badger's body stays raw.
WATER: none in frame.
CROWD: 0.
...
hollow and dragging soil inward (posture 3), so two furrows are pushed up
between his paws. Face lowered deep toward the soil, soil dust on his nose tip,
back rounded, tail low and straight behind. No clothes, natural badger
...
TONE: evening light reaching into the box. 🔴 THE SOIL IS THE DARKEST THING ON
THE SPREAD AND THE CROWN OF THE BULB IS THE LIGHTEST. 🔴 0 GREEN anywhere on this
spread - no sprout, no shoot, no leaf. NO letters, numbers or price tags.
```
...
print edges, the most worked place in the book. Badger, goose, box and bucket
base stay raw at 0-2 strokes. The finish that began on the tulips ends here.
...
his weight down through straight arms so his shoulders rise beside his ears,
eyes on the ground between his own paws, mouth closed (posture 3). At upper
right the Old Goose hooks her neck down to look at the same place (posture 3).
Neither body is moving. No clothes on either, natural animal proportion,
forepaws used as hands, wings not hands.
SETTING: the soil levelled flat - the bulb is not visible at all - with two paw
prints pressed side by side, in the exact place where the crown showed on p1.
The wooden box edge. Nothing else.
TONE: low warm evening light, throwing shadow only along the rims of the two
prints. 🔴 0 GREEN anywhere on this spread. NO letters, numbers or price tags.
```
