...
2026-09-14 · 상태: ✅ **구현·배포 완료**(2026-09-14) · 뒤이은 변경 = 기본 화면 온라인 놀이 · 책 단위 색칠책 인쇄 · 목록 갈래▸책▸낱말 · 숨은그림 갈래 라벨 · 색칠 뒤 동화책 쪽 리빌 · **온라인 워크지**(칸 목록 + 큰 쓰기 칸 · 한글 3번 · 소리 끝나고 다음 · 낱말 그림) · **영어 조각 나눔**(`?part=`) · **종류 대표 페이지 넷**(SSR + 화면, 큰 검색어) · 소개 페이지 「무료 활동 모음」 절 · 헤더(로고·둘러보기)·전체 높이 사이드바 (2026-09-15)
