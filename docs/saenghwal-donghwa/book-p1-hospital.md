...
- SCENE: `Imaginative cutaway of Hori's body as a cozy castle world: tiny cute shiny soldier-cells looking tired, while fuzzy little black germ-blobs (mischievous, not scary — round with silly faces) swarm around. A storybook-style diagram Hori is peering at with wonder. Playful, whimsical, soft.`
...
- **번호 규칙 대신 감정 스크립트**: 안전편의 "번호 규칙" 대신, 감정편 성격에 맞춰 "후우 크게 숨(P7)" 자기조절 동작을 심음.
