# -*- coding: utf-8 -*-
"""스티커 블록 4×6 · 5×5 · 4×4 · 3×3 · 2×4 — 윗면에 스티커를 붙이고, 사방 1mm 턱이 스티커 가장자리를 감싼다.

실행:  python sticker_block.py      → out/sticker_<이름>.stl · .step · .png  (SIZES 마다)

2026-09-15 사용자: 「5 by 5 랑 3 by 3 만들어줘」 · 「4 by 4 도」 · 「2 x 4 도」 — 같은 규칙에 돌기 수만 바꾼다.
...
SIZES       = [('4x6', 6, 4), ('5x5', 5, 5), ('4x4', 4, 4), ('3x3', 3, 3), ('2x4', 4, 2)]   # (이름, 돌기 X, 돌기 Y)
